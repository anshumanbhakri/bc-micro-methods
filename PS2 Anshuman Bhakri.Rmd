...
### Polynomial Relationship : p=7 seems to fit the best
...
## Question 3 
### After Cross Validation p=7 seems the best fit still
```{r, echo=TRUE}
...
## Question 7
### In the middle of the graph from Temperature from 40-70 , Lowess and Natural Cubic SPline are doing pretty great. Whereas at the extreme ends Polynomial relationship from Cross validation (i.ie p=7) is doing decent.
```{r, echo=TRUE,warning=FALSE}
